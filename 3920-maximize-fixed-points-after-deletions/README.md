<h2><a href="https://leetcode.com/problems/maximize-fixed-points-after-deletions/?envType=problem-list-v2&envId=sorting">3920. Maximize Fixed Points After Deletions</a></h2><h3>Hard</h3><hr><p>You are given an integer array <code>nums</code>.</p>
